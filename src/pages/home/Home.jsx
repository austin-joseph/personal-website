				...
				<div id="projects">
					...
					{/* <div id="projects">
						<div className="element">
							<div className="title underline">Raising The Bar</div>
							<div className="subtitle">A web based bartender training and testing application</div>
							<div className="body"><a href="">Description</a><a href="">Go To Project</a> </div>
						</div>
						<div className="element">
							<div className="title underline">Raising The Bar</div>
							<div className="subtitle">A web based bartender training and testing application</div>
					...
					<div id="about-wrapper">
						<div className="highlights" id="highlights-1">
							<div>
								...
								<div className={"highlight-description"}>Bachelors of Computer Science</div>
								<div className={"highlight-description"}>Stony Brook University</div>
						...
						<div id="about-body">
							...
							<div id="education">
								Lorem ipsum dolor sit amet consectetur adipisicing elit. Accusamus ut ipsa neque, nisi fugit mollitia exercitationem sapiente repellendus reprehenderit. Aut facere aliquam hic veritatis, voluptate ipsa nobis itaque quo voluptas?
							</div>
						</div>
					</div>
				</div>
